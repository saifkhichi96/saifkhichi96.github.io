...
<article data-custom-class="body">
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used by Neustar to collect data on user visits to a site, such as what pages have been accessed. The registered data is used to categorise the user’s interest and demographic profiles in terms of resales for targeted marketing.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Purpose:</td>
                  <td><span>Set by Scorecardresearch on sites to help site owners collect information about general visitation patterns of the site visitors</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>www.saifkhichi.com</span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Service:</td>
                  <td><span>Mediamath  <a href="https://www.mediamath.com/privacy-policy/"  target="_blank">View Service Privacy Policy</a>  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>United States</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>TDCPM</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Set by the CloudFlare service to register a unique ID that identifies a returning user’s device. The ID is used for targeted ads. Expires after 1 year.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.adsrvr.org</span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used to register anonymised user data, such as IP address, geographical location, visited websites, and what ads the user has clicked, with the purpose of optimising ad display based on the user's movement on websites that use the same ad network. Expires in 1 year.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.rfihub.com</span></td>
                ...
                <tr>
                  <td>Service:</td>
                  <td><span>Rocket Fuel  <a href="https://rocketfuel.com/privacy/"  target="_blank">View Service Privacy Policy</a>  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>__________</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>__gads</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Set by Google Ad Manager on a site to help with measuring how a user interacts with the ads on that domain and preventing the same ads from being shown to the user too many times.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.saifkhichi.com</span></td>
                ...
                <tr>
                  <td>Service:</td>
                  <td><span>Google AD Manager  <a href="https://policies.google.com/privacy"  target="_blank">View Service Privacy Policy</a>  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>Netherlands</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>dpixel</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>A pixel tracking cookie that tracks how a user interacts with an advert served by Quantcast</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>www.saifkhichi.com</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>didts</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used to deliver adverts that are more relevant to user's interests. It is also used to limit the number of times a user sees an advertisement as well as help measure the effectiveness of the advertising campaign. It is valid for 2 months or 1 year.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.pippio.com</span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Purpose:</td>
                  <td><span>Contains a unique ID to identify a user</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.addthis.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>Adform  <a href="https://site.adform.com/privacy-center/overview"  target="_blank">View Service Privacy Policy</a>  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>United States</span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Expires in:</td>
                  <td><span>7 months 27 days</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>IMRID</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used to collect behavioral information such as a users navigation of a website to build an online profile that can be used for the targeting of advertisements.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.imrworldwide.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>DoubleClick  <a href="https://policies.google.com/privacy"  target="_blank">View Service Privacy Policy</a>  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>__________</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>ruds</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>A session cookie used to register anonymised user data, such as IP address, geographical location, visited websites, and what ads the user has clicked, with the purpose of optimising ad display based on the user's movement on websites that use the same ad network.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.rfihub.com</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>TapAd_DID</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used to determine what type of devices (smartphones, tablets, computers, TVs etc.) is used by a user. Expires after 2 months.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.tapad.com</span></td>
                ...
                <tr>
                  <td>Service:</td>
                  <td><span>Tapad  <a href="https://www.tapad.com/privacy-policy"  target="_blank">View Service Privacy Policy</a>  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>United States</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>_cc_aud</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used by Lotame to store encoded audience data for interest based advertising</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.crwdcntrl.net</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>bkdc</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used by Bluekai to collects data on visitor browsing habits on different websites using the tracker’s unique ID number. The data is later used for optimizing marketing campaigns</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.bluekai.com</span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Expires in:</td>
                  <td><span>1 year 27 days</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>checkForPermission</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Ensures that only ads that may be of interest to a user.are visible.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.bidr.io</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>Beeswax  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>__________</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>test_cookie</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>A session cookie used to check if the user’s browser supports cookies.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>_kuid_</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Registers a unique ID that identifies a returning user's device. The ID is used for targeted ads.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.krxd.net</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>Salesforce DMP  <a href="https://www.salesforce.com/products/marketing-cloud/sfmc/salesforce-dmp-privacy/"  target="_blank">View Service Privacy Policy</a>  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>__________</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>bito</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used by Beeswax as a unique Client ID when the client is bidding for an ad</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.bidr.io</span></td>
                ...
                <tr>
                  <td>Service:</td>
                  <td><span>Beeswax  <a href="https://www.beeswax.com/privacy.html"  target="_blank">View Service Privacy Policy</a>  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>__________</span></td>
                ...
                <tr>
                  <td>Expires in:</td>
                  <td><span>1 year 29 days</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used to measure the conversion rate of ads presented to the user. Expires in 1.5 years.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.doubleclick.net</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>_li_ss</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used by Liveintent for target based advertising by collecting unique visitor information</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>i.liadm.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>Liveintent  <a href="https://liveintent.com/services-privacy-policy/"  target="_blank">View Service Privacy Policy</a>  </span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>google_adsense_settings</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>__________</span></td>
  ...
  <div><span data-custom-class="heading_2"><span><strong><u><br>Social networking cookies:</u></strong></span></span></div>
  <div>
    <p><span><span><span data-custom-class="body_text">These cookies are used to enable you to share pages and content that you find interesting on our Websites through third party social networking and other websites. These cookies may also be used for advertising purposes.</span></span></span></p>
    <div>
      <span data-custom-class="body_text">
        <section data-custom-class="body_text">
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>ouid</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Used by AddThis to enable visitors to share content with a range of networking and sharing platforms. It is associated with the AddThis social sharing widget which is commonly embedded in their site. Expires in 1 year.</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.addthis.com</span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>na_id</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>Sets a unique user id to track a user on a site. Persistent cookie that stays for 730 days</span></td>
                </tr>
                <tr>
                  <td>Provider:</td>
                  <td><span>.addthis.com</span></td>
                ...
                <tr>
                  <td>Service:</td>
                  <td><span>Addthis  <a href="https://www.oracle.com/legal/privacy/privacy-policy.html"  target="_blank">View Service Privacy Policy</a>  </span></td>
                </tr>
                <tr>
                  <td>Country:</td>
                  <td><span>United States</span></td>
  ...
  <div><span data-custom-class="heading_2"><span><strong><u><br>Unclassified cookies:</u></strong></span></span></div>
  <div>
    <p><span><span><span data-custom-class="body_text">These are cookies that have not yet been categorized. We are in the process of classifying these cookies with the help of their providers.</span></span></span></p>
    <div>
      <span data-custom-class="body_text">
        <section data-custom-class="body_text">
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Provider:</td>
                  <td><span>beacon.walmart.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>__________  </span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Expires in:</td>
                  <td><span>14 hours 8 minutes</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Provider:</td>
                  <td><span>gist.github.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>__________  </span></td>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>vglnk.PartnerRfsh.p</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>__________</span></td>
                ...
                <tr>
                  <td>Provider:</td>
                  <td><span>links.services.disqus.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>__________  </span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Provider:</td>
                  <td><span>live.rezync.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>__________  </span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Expires in:</td>
                  <td><span>1 year 30 days</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>io.narrative.guid.v2</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>__________</span></td>
                ...
                <tr>
                  <td>Provider:</td>
                  <td><span>io.narrative.io</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>__________  </span></td>
                ...
                <tr>
                  <td>Expires in:</td>
                  <td><span>1 year 5 months 29 days</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Provider:</td>
                  <td><span>.linksynergy.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>__________  </span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Provider:</td>
                  <td><span>.scorecardresearch.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>__________  </span></td>
                ...
                <tr>
                  <td>Expires in:</td>
                  <td><span>1 year 11 months 19 days</span></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div>
            <table>
              <tbody>
                <tr>
                  <td>Name:</td>
                  <td><span>google_ama_config</span></td>
                </tr>
                <tr>
                  <td>Purpose:</td>
                  <td><span>__________</span></td>
          ...
          <div>
            <table>
              <tbody>
                ...
                <tr>
                  <td>Provider:</td>
                  <td><span>.cardlytics.com</span></td>
                </tr>
                <tr>
                  <td>Service:</td>
                  <td><span>__________  </span></td>
  ...
  <div>
    <span><span data-custom-class="body_text">Third parties may serve cookies on your computer or mobile device to serve advertising through our Websites. These companies may use information about your visits to this and other websites in order to provide relevant advertisements about goods and services that you may be interested in. They may also employ technology that is used to measure the effectiveness of advertisements. This can be accomplished by them using cookies or web beacons to collect information about your visits to this and other sites in order to provide relevant advertisements about goods and services of potential interest to you. The information collected through this process does not enable us or them to identify your name, contact details or other details that directly identify you unless you choose to provide these.</span></span>
    <span>
      <span>
        <span>
          <span>
      ...
      <span>
        <span>
          <span data-custom-class="body_text">
            ...
            <bdt class="question">saifkhichi96@gmail.com</bdt>
            or by post to:
          </span>
        </span>
      </span>
  ...
  <div><span data-custom-class="body_text"><br></span></div>
  <div>
    <span>
      <span>
        <span data-custom-class="body_text">
  ...
  <div>
    <span>
      <bdt class="question"><span data-custom-class="body_text">Gerhart-Hauptmann-Straße 24, 67663 Kaiserslautern, Germany</span></bdt>
      <span data-custom-class="body_text">
        <bdt class="block-component"></bdt>
      </span>
    </span>
  ...
  <div>
    <span data-custom-class="body_text">
      <span>
        <bdt class="question">KL</bdt>
        <bdt class="block-component"></bdt>
        ,
        <bdt class="question">Rheinland-Pfalz</bdt>
        <bdt class="statement-end-if-in-editor"></bdt>
        <bdt class="block-component"></bdt>
        <bdt class="question">67663</bdt>
        <bdt class="statement-end-if-in-editor"></bdt>
        <bdt class="block-component"></bdt>
        <bdt class="block-component"></bdt>
      </span>
...
<footer>
  This cookie policy was created using <a  href="https://termly.io/en/products/cookie-consent-manager/?ftseo">Termly’s Cookie Consent Manager</a>.
</footer>
